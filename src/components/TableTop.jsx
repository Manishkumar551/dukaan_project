...
const TableTop = () => {
  return (
    <div className="flex justify-between items-center ">
      <div className="flex items-center h-10 w-96 rounded border border-gray-300 ">
      ...
      <div className="flex gap-4">
        <div className="grid grid-flow-col items-center gap-2 h-9 pl-3.5 pr-3.5 rounded border border-gray-300">
          <p>Sort</p>
          <svg
            width="14"
            height="12"
